...
if (!isset($_SESSION['user_id']) || empty($_SESSION['user_id']) || $_SESSION['role'] !== 'obgyn') {
    ...
    <div class="main-content">
        <div class="wrap-content container" id="container">
            <section id="page-title">
                <div class="row">
                    <div>
                        <h1 class="main-title">OBGYN Dashboard</h1>
                    </div>
                </div>
            </section>
                        ...
                        <a href="patient_list.php" style="text-decoration: none; color: inherit;">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h2 class="count">
                                        <?php
                                        $result = mysqli_query($conn, "SELECT COUNT(*) AS total_patients FROM patient_record WHERE obgyn_id IS NOT NULL");
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = "SELECT patient_name, province, city, barangay, contact_no, creationdate FROM patient_record WHERE obgyn_id = ? AND DATE(creationdate) = ? ORDER BY creationdate DESC LIMIT 10";

                                                    $stmt = mysqli_prepare($conn, $query);
                                                    mysqli_stmt_bind_param($stmt, "is", $obgyn_id, $today);
