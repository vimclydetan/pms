    ...
    <div class="main-content">
        <div class="wrap-content container" id="container">
            <section id="page-title">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="main-title">Delivered and Expectant Report</h1>
                    </div>
            ...
            <section id="pdf-preview" style="margin-top: 20px;">
                <div class="row">
                    <div class="col-md-12">
                        <iframe id="pdfFrame" src="report1.php" type="application/pdf" width="100%" height="600px" frameborder="0">
