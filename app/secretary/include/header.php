<aside class="sidebar">
    ...
    <ul class="nav-items">
        <li class="nav-item">
            <a href="sec_dashboard.php" class="nav-link"> 
        ...
        <li class="nav-item">
            <a href="calendar_appointments.php" class="nav-link">
                <i class="fa-solid fa-calendar"></i>
                <span class="nav-text">Calendar of Appointments</span> <!-- Fixed typo -->
            </a>
        </li>

        <li class="nav-item">
            <a href="preview_report1.php" class="nav-link">
                <i class="fa-solid fa-file"></i>
                <span class="nav-text">Maternity Report</span>
            </a>
        </li>

        <li class="nav-item">
            <a href="preview_report2.php" class="nav-link">
                <i class="fa-solid fa-file"></i>
                <span class="nav-text">Patients Report</span>
            </a>
        </li>
    </ul> 
