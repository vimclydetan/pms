...
$query = "
    SELECT pr.*, m.name AS midwife_name
...
<body>
    ...
    <div class="main-content">
        <div class="wrap-content container" id="container">
            ...
            $localUrl = "http://192.168.100.2/thesis%20v.1.0/app/midwife/qr_view.php?viewid=" . $patient_id;
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th scope>Assigned Midwife</th>
                                <td>
                                    <?php
                                    if (!empty($patient['midwife_name'])) {
                                        echo htmlentities($patient['midwife_name']);
                                    } else {
                                        echo '—';
                                    }
                                    ?>
                        ...
                        <form id="medicalForm" action="process_form.php?viewid=<?php echo $vid; ?>" method="POST" onsubmit="return disableMedicalFormSubmit();">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="serviceSelector" class="form-select" name="serviceSelector">
                                        ...
                                        <option value="midwife_delivery">Midwife Assisted Delivery</option>
                                    </select>
                                </div>
                                ...
                                <div id="midwife_delivery" class="service-fields">
                                    <h6>Midwife Assisted Delivery</h6>
                                    <div class="col-md-3">
                                        <label class="form-label">Delivery Date</label>
                                        <input type="date" name="midwife_delivery_date" class="form-control">
                                    </div>
                                    <label class="form-label">Pregnancy Outcome</label>
                                    <select name="midwife_delivery_outcome" class="form-select">
                                        <option value="">Select</option>
                                    ...
                                    <select name="midwife_delivery_gender" class="form-select">
                                        <option value="">Select</option>
                                        <option>Male</option>
                                        <option>Female</option>
                                    </select>
                                    <label class="form-label">Birth Weight</label>
                                    <input type="text" name="midwife_delivery_weight" class="form-control">
                                    <label class="form-label">Notes</label>
                                    <textarea name="midwife_delivery_notes" class="form-control"></textarea>
                                </div>
