...
switch ($serviceSelector) {
    ...
    case 'midwife_delivery':
        $fieldData = [
            'Delivery Date' => ['value' => $_POST['midwife_delivery_date'], 'type' => 'date'],
            'Pregnancy Outcome' => ['value' => $_POST['midwife_delivery_outcome'], 'type' => 'select'],
            'Gender of Baby' => ['value' => $_POST['midwife_delivery_gender'], 'type' => 'select'],
            'Birth Weight' => ['value' => $_POST['midwife_delivery_weight'], 'type' => 'text'],
            'Notes' => ['value' => $_POST['midwife_delivery_notes'], 'type' => 'textarea'],
        ];
        break;
